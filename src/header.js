      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link as={Link} to="/props" className='fs-5'>Props</Nav.Link>
            {/* <Nav.Link as={Link} to="/link" className='fs-5'>JSX</Nav.Link> */}
            <Nav.Link as={Link} to="/router" className='fs-5'>Router</Nav.Link>
            <Nav.Link as={Link} to="/redux" className='fs-5'>Redux
            </Nav.Link>
